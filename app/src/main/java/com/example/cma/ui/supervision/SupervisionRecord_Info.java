...
public class SupervisionRecord_Info extends AppCompatActivity implements View.OnClickListener{
    ...
    public void initView(){
        ...
        supervisor_text = (TextView)findViewById(R.id.supervisor_text);
        superviseDate_text = (TextView)findViewById(R.id.superviseDate_text);
        supervisedPerson_text = (TextView)findViewById(R.id.supervisedPerson_text);
        record_text = (TextView)findViewById(R.id.record_text);
        conclusion_text = (TextView)findViewById(R.id.conclusion_text);
        operator_text = (TextView)findViewById(R.id.operator_text);
    ...
    public void onDelete(){
        String address = AddressUtil.SupervisionRecord_deleteOne();
    ...
    public void getSupervisionRecord(){
        new Thread(new Runnable() {
            @Override
            public void run() {
                String address = AddressUtil.SupervisionRecord_getAll(supervisionRecord.getPlanId());
    ...
    private void parseJSONWithGSON(String jsondata){
        ...
        if(record.equals("[]")){
            ...
            if(list.size()>1){
                ToastUtil.showShort(SupervisionRecord_Info.this,"记录条数大于2");
            }
