...
public class EquipmentApplication_Add extends AppCompatActivity implements View.OnClickListener,CompoundButton.OnCheckedChangeListener,Spinner.OnItemSelectedListener{
    ...
    public void onSave(){
        if(applicant_text.getText().toString().isEmpty()||
            ...
            ToastUtil.showShort(EquipmentApplication_Add.this, "请填写完整！");
            return;
        }
        postSave();
    }
    ...
    public void postSave(){
        String address = AddressUtil.EquipmentApplication_addOne();
        ...
        HttpUtil.sendOkHttpWithRequestBody(address,requestBody,new okhttp3.Callback(){
            ...
            public void onResponse(Call call, Response response)throws IOException {
                ...
                if(code == 200 && msg.equals("成功")) {
                    ToastUtil.showShort(EquipmentApplication_Add.this, "提交成功！");
                    finish();
                }
            }
            @Override
            public void onFailure(Call call,IOException e){
                ToastUtil.showShort(EquipmentApplication_Add.this, "提交失败！");
            }
        });
    }
    ...
    private void showResponse() {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                //适配器
                spinnerAdapter = new ArrayAdapter<String>(EquipmentApplication_Add.this, android.R.layout.simple_spinner_item, spinnerData);
                //设置样式
